        ...
        <section>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p
              id="uidnote"
              className={
                gmailFocus && user && !validGmail ? "instructions" : "offscreen"
              }
            >
              <FontAwesomeIcon icon={faInfoCircle} />
              Enter a valid Gmail
            ...
            <button
              disabled={!validName || !validPwd || !validMatch ? false : false}
            >
              Sign Up
            </button>
          </form>
          <p>
            ...
            <br />
            <span className="line">
              <Link to="/" style={{color:"white"}}>Sign In</Link>
            </span>
          </p>
        </section>
      )}
